 ...
 * Showcase layout.
 *
 * Shell for storefront listing pages (product grid). Shares the site header
 * and footer with the default layout but marks the body with the
 * `layout-showcase` class and renders content full-width — customize this
 * file freely to restyle the storefront without touching other pages.
 */
